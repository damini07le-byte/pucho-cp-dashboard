...
import { User, Lock, Mail, ArrowRight, Sparkles, Circle } from 'lucide-react';
...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!signup) {
            setError('Signup functionality is not yet implemented in AuthContext');
            setLoading(false);
            return;
        }
            ...
            <div className="w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-12 relative z-10 items-center">
                ...
                <div className="hidden md:block space-y-8 pl-12">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-1">
                            <p className="font-bold text-[#111834] text-lg">Join Pucho.ai Community</p>
                            <p className="text-[10px] font-black text-purple-600 tracking-widest uppercase">START YOUR AUTOMATION JOURNEY</p>
                        </div>
                        ...
                        <p className="text-gray-500 text-sm max-w-sm leading-relaxed">
                            Sign up today to start building your AI-driven communication agents. Faster, smarter, and scalable.
                        </p>
                    </div>
                ...
                <div className="flex items-center justify-center">
                    <div className="bg-white/80 backdrop-blur-2xl p-10 rounded-[40px] shadow-[0_32px_80px_-20px_rgba(0,0,0,0.08)] border border-white w-full max-w-md">
                        <div className="mb-8">
                            <h2 className="text-3xl font-black text-[#111834] mb-2">Create Account</h2>
                            <p className="text-gray-400 font-medium">Get started with your automation dashboard.</p>
                        </div>
